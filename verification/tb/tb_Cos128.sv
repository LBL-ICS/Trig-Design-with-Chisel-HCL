 ...
 *
 * Author: Xiaokun Yang and Mario Vega, University of Houston Clear Lake 
 * Date: June 2022
 *
...
`elsif COS_N128_PD8_BW128
parameter LATENCY = 157; //? 34+8+1
...
reg [127:0]  output_cos[TEST_SIZE-1:0]; 
...
initial begin
   ...
   $readmemh("../golden/rtl-cos-output128.txt",output_cos);
end
