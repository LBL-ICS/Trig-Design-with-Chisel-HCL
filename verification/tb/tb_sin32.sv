...
`include "tb_func32.sv"

initial begin
   $readmemh("../golden/rtl-theta-input32.txt",input_theta);
   $readmemh("../golden/rtl-sin-output32.txt",output_sin);
end
...
Sin_n32_pd32_bw32 u_Sin_n32_pd32_bw32(
  .clock (clock ),
  .reset (reset ),
  .io_ready (io_ready ),
  .io_in (io_in ),
