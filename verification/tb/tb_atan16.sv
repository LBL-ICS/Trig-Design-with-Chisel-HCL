...
reg [15:0]  output_theta[TEST_SIZE-1:0]; 
reg [15:0]  input_y[TEST_SIZE-1:0];

`include "tb_func_atan_16.sv"

initial begin
   $readmemh("../golden/rtl-y-input16.txt",input_y);
   $readmemh("../golden/rtl-atan-output16.txt",output_theta);
end
  ...
  @(negedge clock);
   while (j  < TEST_SIZE) begin
	...
	if (io_valid) begin
      ...
      if(output_theta[j]==15'h248D2) begin
