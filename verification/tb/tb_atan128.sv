...
reg [127:0]  output_theta[TEST_SIZE-1:0]; 
reg [127:0]  input_y[TEST_SIZE-1:0];

`include "tb_func_atan_128.sv"

initial begin
   $readmemh("../golden/rtl-y-input128.txt",input_y);
   $readmemh("../golden/rtl-atan-output128.txt",output_theta);
end
...
Atan_n64_pd64_bw128 u_Atan_n64_pd64_bw128 (
  .clock (clock ),
  .reset (reset ),
  .io_ready (io_ready ),
  .io_in (io_in ),
