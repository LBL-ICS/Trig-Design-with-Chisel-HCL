...
`elsif COS_N64_PD8_BW64
parameter LATENCY = 97; //? 34+8+1
...
reg [63:0]  output_cos[TEST_SIZE-1:0]; 
reg [63:0]  input_theta[TEST_SIZE-1:0];

`include "tb_func64.sv"

initial begin
   $readmemh("../golden/rtl-theta-input64.txt",input_theta);
   $readmemh("../golden/rtl-cos-output64.txt",output_cos);
end
